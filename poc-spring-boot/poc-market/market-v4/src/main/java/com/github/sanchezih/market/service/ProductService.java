...
import com.github.sanchezih.market.domain.repository.RTypeProduct;
...
public class ProductService implements IProduct {
	...
	public Product create(ProductDto dto) {
		...
		Optional<TypeProduct> typeProductOptional = rTypeProduct.findById(dto.getTypeId());
		if (typeProductOptional.isPresent()) {
			product.setTypeProduct(typeProductOptional.get());
		}
